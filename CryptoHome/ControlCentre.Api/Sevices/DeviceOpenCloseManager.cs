...
{
    public class DeviceOpenCloseManager : DeviceManagerBase, IDeviceManager
    {

        public DeviceOpenCloseManager(CryptohomeDevice device) : base(device)
        {
        }

        public void DeviceInit()
        {
            _device.CurrentState = "close";
            _device.PreviousState = "close";
